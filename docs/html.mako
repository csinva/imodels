...
<%def name="module_index(module)">
  ...
  <nav id="sidebar">
    ...
    <li><h3>Our favorite methods</h3>
        ...
        <li><a href="https://csinva.io/imodels/autoopttree.html" title="Certifiably optimal sparse decision trees">AutoOptTree</a><span class="post-tag" title="Discovered by an autoresearch loop">autoresearch</span><span class="post-date">Sep 2026</span></li>
        <li><a href="https://csinva.io/imodels/gpgam.html" title="Additive Gaussian processes over binned features">GPGam</a><span class="post-tag" title="Discovered by an autoresearch loop">autoresearch</span><span class="post-date">Sep 2026</span></li>
        <li><a href="https://csinva.io/imodels/mdi_plus.html" title="Flexible tree-based feature importance">MDI+</a><span class="post-date">Jul 2023</span></li>
        <li><a href="https://csinva.io/imodels/shrinkage.html" title="Post-hoc regularization for tree-based methods">Hierarchical shrinkage</a><span class="post-date">Feb 2022</span></li>
        <li><a href="https://csinva.io/imodels/figs.html" title="Fast interpretable greedy-tree sums">FIGS</a><span class="post-date">Jan 2022</span></li>
        </ul>
    </li>
    % if variables:
...
<header id="site-header">
  ...
  <p id="site-tagline">imodels. Sklearn-compatible interpretable models.</p>
