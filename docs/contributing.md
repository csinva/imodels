...
[Tests](tests) are run with [pytest](https://docs.pytest.org/en/stable/) - make sure they pass before pushing code, and that new models pass a reasonable set of tests.
